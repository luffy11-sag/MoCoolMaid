...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    <div class="signup-box">
        <div class="form-group">
            ...
            <asp:TextBox ID="txtDateOfBirth" runat="server" placeholder="Date of Birth" TextMode="Date" CssClass="form-control" />
            ...
            <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control ddlRole" OnSelectedIndexChanged="ddlRole_SelectedIndexChanged" AutoPostBack="true">
            ...
            <label for="ddlRole">District</label>
            <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="form-control ddlRole">
            </asp:DropDownList>
