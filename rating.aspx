<%@ Page Title="Rating" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="rating.aspx.cs" Inherits="MoCoolMaid.rating" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    <div class="rating-box">
        <div class="rating-container">
            ...
            <asp:Button runat="server" ID="btnSubmit" Text="Submit" CssClass="submit-button" />
        </div>
    </div>
</asp:Content>
